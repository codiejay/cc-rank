// ccrank statusline — prints your live room rank, e.g.  CC-Rank #2/5 · leaderboard ↗
...
async function rankSegment(cfg) {
  ...
  const roomUrl = base + "/r/" + cfg.roomCode;
  ...
  // gets auto-linkified by terminals that only detect plain URLs.
  ...
  const deleted = () => `\x1b[1;38;5;203mroom deleted\x1b[0m \x1b[2m·\x1b[0m \x1b[94;4m${link(base, "make a new room ↗")}\x1b[0m`;
  const fromCache = (c) =>
