...
async function rankSegment(cfg) {
  ...
  // ?me=<github_id> (public, cosmetic) makes the page highlight their row.
  const me = cfg.githubId ? "?me=" + cfg.githubId : "";
  const roomUrl = (cfg.roomCode ? base + "/r/" + cfg.roomCode : base + "/") + me;
